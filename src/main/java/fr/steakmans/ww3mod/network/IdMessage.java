...
public class IdMessage implements IMessage {
	...
	public IdMessage(String lastname, String name, int age) {
	...
	public static class Handler implements IMessageHandler<IdMessage, IMessage> {

		@Override
		public IMessage onMessage(IdMessage message, MessageContext ctx) {
				...
				if(!stack.hasTagCompound()) {
					...
					stack.getTagCompound().setBoolean("fake", false);
