...
public class CustomMainMenu extends GuiScreen {
	   ...
	   private static final Logger LOGGER = LogManager.getLogger();
	    ...
	    public void initGui()
	    {
	        ...
	        {
	            this.splashText = "OOoooOOOoooo! Terrifiant!";
	        } else {
	        	this.splashText = "Bienvenue Citoyen!";
	        }
	    ...
	    {
	        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, p_73969_1_, I18n.format("menu.connecttoserver")));
	    }
	    ...
	    protected void actionPerformed(GuiButton button) throws IOException
	    {
	        ...
	        if (button.id == 1)
	        {
	            FMLClientHandler.instance().connectToServer(this, new ServerData("3Divisions", "ww3-mc.fr:25565", false));
	        }
