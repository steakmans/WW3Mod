...
public class RegisterCharacter extends GuiScreen {
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if(button.id == 4) {
			...
			WW3Mod.instance.network.sendToServer(new IdMessage(nom.getText(), prenom.getText(), intage));
			WW3Mod.instance.network.sendToServer(new RegisterMessage(prenom.getText(), nom.getText(), intage));
